...
# Pantalla del menu - Hecho por Ximena -------------------------------------------------------
menu = turtle.Screen()
...
# Asignamos la figura de nuestras tortugas - Hecho por todos ---------------------------------
...
# Crea al jugador - Hecho por Daniela y Kevin ------------------------------------------------
...
# Inicia la musica del juego - Sonido agregado por Kevin
...
# Explosión de los aliens - Hecho por Gustavo ------------------------------------------------
...
# Mueve en el eje X la navecita a la izquierda - Hecho por Ximena ----------------------------
def hacia_izq():
    x = navecita.xcor()
    x -= navecitaspeed
    if x < -280:
...
# Colision alien - bala - Hecho por todos ----------------------------------------------------
...
# Crea las teclas para jugar - Hecho por Daniela ---------------------------------------------
turtle.listen()
...
# Bucle del juego - Escrito y modificado por todos -------------------------------------------
...
while True:
    ...
    for alien in aliens:
        ...
        if Choque_alien_bala(bulletv, alien): # Modificacion hecha por Gustavo --------------
    ...
    if bulletvstate == "fire": # - Hecho por Gustavo ----------------------------------------
        y = bulletv.ycor()
        y += bulletvspeed
        bulletv.sety(y)
    ...
    if bulletv.ycor() > 275: # - Hecho por Gustavo ------------------------------------------
        bulletv.hideturtle()
        bulletvstate = "ready"
